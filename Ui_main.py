...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(250, 10, 291, 324))
        ...
        self.localaddresLabel = QtWidgets.QLabel(self.editFrame)
        self.localaddresLabel.setObjectName("localaddresLabel")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.localaddresLabel)
        self.localaddresEdit = QtWidgets.QLineEdit(self.editFrame)
        self.localaddresEdit.setObjectName("localaddresEdit")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.localaddresEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fastopenCheckBox.setToolTip(_translate("MainWindow", "Turn on one-time authentication and header verification (need server support)"))
        ...
        self.localaddresLabel.setText(_translate("MainWindow", "本地 IP"))
        self.localaddresEdit.setText(_translate("MainWindow", "127.0.0.1"))
