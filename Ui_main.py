...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(260, 10, 294, 301))
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.timeoutLabel)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.timeoutSpinBox)
        self.remarksLabel = QtWidgets.QLabel(self.editFrame)
        self.remarksLabel.setObjectName("remarksLabel")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.remarksLabel)
        self.remarksEdit = QtWidgets.QLineEdit(self.editFrame)
        self.remarksEdit.setText("")
        self.remarksEdit.setObjectName("remarksEdit")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.remarksEdit)
        ...
        self.b_yes.setGeometry(QtCore.QRect(290, 330, 91, 61))
        self.b_yes.setObjectName("b_yes")
        self.b_exit = QtWidgets.QPushButton(self.centralWidget)
        self.b_exit.setGeometry(QtCore.QRect(430, 330, 91, 61))
        self.b_exit.setObjectName("b_exit")
        self.loggingBrowser = QtWidgets.QTextBrowser(self.centralWidget)
        self.loggingBrowser.setGeometry(QtCore.QRect(10, 410, 541, 171))
        self.loggingBrowser.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.loggingBrowser.setFocusPolicy(QtCore.Qt.ClickFocus)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.encryptComboBox.setItemText(1, _translate("MainWindow", "chacha20-poly1305"))
        self.encryptComboBox.setItemText(2, _translate("MainWindow", "aes-128-cfb"))
        self.encryptComboBox.setItemText(3, _translate("MainWindow", "aes-192-cfb"))
        self.encryptComboBox.setItemText(4, _translate("MainWindow", "salsa20"))
        self.encryptComboBox.setItemText(5, _translate("MainWindow", "chacha20"))
        self.encryptComboBox.setItemText(6, _translate("MainWindow", "rc4"))
        self.encryptComboBox.setItemText(7, _translate("MainWindow", "rc4-md5"))
        self.encryptComboBox.setItemText(8, _translate("MainWindow", "table"))
        self.encryptComboBox.setItemText(9, _translate("MainWindow", "chacha20-ietf-poly1305"))
        self.encryptComboBox.setItemText(10, _translate("MainWindow", "*xchacha20-ietf-poly1305"))
        self.encryptComboBox.setItemText(11, _translate("MainWindow", "aes-128-gcm"))
        self.encryptComboBox.setItemText(12, _translate("MainWindow", "aes-192-gcm"))
        self.encryptComboBox.setItemText(13, _translate("MainWindow", "aes-256-gcm"))
        self.encryptComboBox.setItemText(14, _translate("MainWindow", "aes-128-ctr"))
        self.encryptComboBox.setItemText(15, _translate("MainWindow", "aes-192-ctr"))
        self.encryptComboBox.setItemText(16, _translate("MainWindow", "aes-256-ctr"))
        self.encryptComboBox.setItemText(17, _translate("MainWindow", "camellia-128-cfb"))
        self.encryptComboBox.setItemText(18, _translate("MainWindow", "camellia-192-cfb"))
        self.encryptComboBox.setItemText(19, _translate("MainWindow", "camellia-256-cfb"))
        self.encryptComboBox.setItemText(20, _translate("MainWindow", "chacha20-ietf"))
        self.encryptComboBox.setItemText(21, _translate("MainWindow", "bf-cfb"))
        self.encryptComboBox.setItemText(22, _translate("MainWindow", "cast5-cfb"))
        self.encryptComboBox.setItemText(23, _translate("MainWindow", "des-cfb"))
        self.encryptComboBox.setItemText(24, _translate("MainWindow", "idea-cfb"))
        self.encryptComboBox.setItemText(25, _translate("MainWindow", "rc2-cfb"))
        self.encryptComboBox.setItemText(26, _translate("MainWindow", "seed-cfb"))
